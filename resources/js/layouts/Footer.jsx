                ...
                <div className="container">
                    <div className="text-center text-gray-700">
                        <div className="text-sm">
                            © 2007 - 2021 Công ty Cổ Phần Dược Phẩm FPT Long
                            Châu Số ĐKKD 0315275368 cấp ngày 17/09/2018 tại Sở
                        ...
                        <div className="text-sm">
                            ...
                            - Email:
                            <a
                                href="mailto:sale@nhathuoclongchau.com"
                                className="text-[var(--primary-light-color)]"
                            >
                                &nbsp;sale@nhathuoclongchau.com&nbsp;
                            </a>
                            - Người quản lý nội dung: nghxtrung
                        </div>
                    </div>
                </div>
            </div>
